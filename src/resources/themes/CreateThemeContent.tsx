...
export const CreateThemeContent = (props: { create: (param: any) => void }) => {
  const defaultTheme = {
    themeName: "",
    bgColor: "#Cf4307",
    txtColor: "#FFFFFF",
  ...
  const getThemeObj = () => {
    const themeObj: { [k: string]: any } = {};
    themeObj[_.camelCase(state.themeName) as keyof typeof themeObj] = {
      id: uuidv4(),
      ...
      <Container>
        <Section>
          ...
          <Row>
            ...
            >
              {getFonts().map(
                (font: string[] | undefined, index: Key | null | undefined) => (
        ...
        <Section>
          ...
          >
            ...
            <a
              href="#"
              style={{ color: state.linkColor, fontFamily: state.font }}
            >
              I am Link
            </a>
          </Preview>
